...
const MODULO_CONFIG: Record<string, { label: string; icon: React.ReactNode; href: string; color: string }> = {
  ...
  egresos:      { label: 'Egresos',      icon: <DollarSign className="w-5 h-5" />,      href: '/dashboard/egresos',       color: 'text-rose-400' },
  balance:      { label: 'Balance',      icon: <TrendingUp className="w-5 h-5" />,      href: '/dashboard/balance',       color: 'text-emerald-400' },
